...
public:
    ...
    void advanceStatus(Order &order) const;
    ...
    virtual void setCompleteOrderId(int newCompletedOrderId);
    ...
    virtual string ordersLeftString() const = 0;
...
public:
    ...
    virtual string ordersLeftString() const;
